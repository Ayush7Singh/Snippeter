    ...
    <div className=''>
      ...
      <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
          <Link to="/create/snippet" class="mr-5 hover:text-white">Create Snippet</Link>
          <a class="mr-5 hover:text-white">Share Snippet</a>
          <a class="mr-5 hover:text-white">Add Snippet</a>
        </nav>
